...
function Dashboard() {
  ...
  // --- NEW: COMMUNICATION & CREDIT TRANSFER (THE MOTTO) ---
            ...
            <div className="space-y-6">
              {requests.map((req) => (
                <div key={req._id} className="border-b border-gray-50 last:border-0 pb-6 last:pb-0">
                  ...
                  {/* COMMUNICATION HUB (Only for Accepted Swaps) */}
                  {req.status === 'accepted' && (
...
return (
  <>
    <QuickGuide /> {/* This will appear as the blurry overlay when the page loads */}
